...
// Custom Google-Colored Logo Component
const GoogleColoredLogo = ({ size = 28, className = "" }) => (
  <div className={`google-logo ${className}`} style={{ width: size, height: size, position: 'relative' }}>
    <svg 
      width={size} 
      height={size} 
      viewBox="0 0 24 24" 
    ...
    >
      ...
      {/* Shield accent */}
      <path 
        d="M12 1L3 5V11C3 16.55 6.84 21.74 12 23C17.16 21.74 21 16.55 21 11V5L12 1ZM12 21C7.31 19.76 4 15.71 4 11V6.3L12 2.19V21Z" 
        fill="#34A853"
      />
      {/* Check mark - moved lower */}
      <path 
        d="M9 14L11 16L15 12" 
        stroke="#EA4335" 
        strokeWidth="2" 
      ...
      {/* Star accent */}
      <path 
        d="M12 6L13.09 8.26L15.5 8.5L13.5 10.24L14.18 12.5L12 11.26L9.82 12.5L10.5 10.24L8.5 8.5L10.91 8.26L12 6Z" 
        fill="#FBBC05"
      />
    </svg>
  </div>
          ...
          <nav>
            ...
            <div className="cta-header">
              <a href="https://wa.me/+918828216807" className="whatsapp-btn">
                <WhatsAppIcon size={16} /> <span className="btn-text">WhatsApp</span>
              </a>
          ...
          <div className="hero-content">
            ...
            <div className="hero-cta">
              ...
              <a href="https://wa.me/+918828216807" className="cta-secondary">
                <WhatsAppIcon size={20} /> WhatsApp Me Now
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="footer-content">
            ...
            <div className="footer-section">
              ...
              <div className="footer-social-grid">
                <a href="https://wa.me/+918828216807" aria-label="WhatsApp"><WhatsAppIcon size={28} /></a>
